...
def run(params: Dict):
    ...
    #ge_scaler_fpath = "/raid/ac.hraeder/LGBM/out.end_to_end_repurposing/preprocess/split_0/x_data_gene_expression_scaler.gz"
    ge_scaler_fpath = Path(params["output_dir"]) / params["ge_scaler_fname"]
    ge_scaler = joblib.load(ge_scaler_fpath)
    ...
    #md_scaler_fpath = "/raid/ac.hraeder/LGBM/out.end_to_end_repurposing/preprocess/split_0/x_data_mordred_scaler.gz"
    md_scaler_fpath = Path(params["output_dir"]) / params["md_scaler_fname"]
    md_scaler = joblib.load(md_scaler_fpath)
...
def main(args):
    ...
    params = cfg.initialize_parameters(
        ...
        default_config="lgbm_params_tcga.txt",
